...
- [arr-ai/arrai](arrai.md) — relational programming language; maintained through generics migration and CVE custodianship
...
- arr-ai/hash — hashing primitives behind frozen
