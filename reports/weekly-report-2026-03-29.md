...
> **Series restamp (2026-07-25):** Headline line stats now exclude `**/vendor/**` and `**/node_modules/**` (same rule as `gather.sh`). Figures below use remeasured excl-vendor totals from current default-branch history. Commits and effort estimates are unchanged. Vendor omitted this week: **+122,152/−33,897** (marcelocantos/rustuml +76,877, marcelocantos/den +45,271). Excl-vendor landed lines: **+119,287/−58,869** (net **+60,418**).
...
**574 commits** | **~+0.12M added / ~−59k removed** (excl. vendor) | **~100-160 person-days traditional equivalent** | **~25-45x multiplier**
...
- **NetworkBackend: bgfx RendererContextI over the wire** — detail in [private week 2026-03-29](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-29.md)
...
*Detailed narrative for this commercial work is in the private sibling: [progress-reports-private — week ending 2026-03-29](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-29.md).*
## Metrics
...
| Total commits | 574 |
| Total lines added | +119,287 |
| Total lines removed | −58,869 |
| Net new lines | +60,418 |
