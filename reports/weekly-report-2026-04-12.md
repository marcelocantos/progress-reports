...
> **Series restamp (2026-07-25):** Headline line stats now exclude `**/vendor/**` and `**/node_modules/**` (same rule as `gather.sh`). Figures below use remeasured excl-vendor totals from current default-branch history. Commits and effort estimates are unchanged. Vendor omitted this week: **+28,978/−2,277** (marcelocantos/csp +11,711, squz/ge +9,647, marcelocantos/sysinfo-mcp +3,532). Excl-vendor landed lines: **+206,034/−83,207** (net **+122,827**).
...
**646 commits** | **~+0.21M added / ~−83k removed** (excl. vendor) | **~120-200 person-days traditional equivalent** | **~30-50x multiplier**
...
- **HMS database de-identification tool hardened through 7 red-team audits** — detail in [private week 2026-04-12](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-04-12.md)
...
- **7-round red-team hardening of HMS de-identification** — detail in [private week 2026-04-12](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-04-12.md)
...
*Detailed narrative for this commercial work is in the private sibling: [progress-reports-private — week ending 2026-04-12](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-04-12.md).*
...
| Total commits | 646 |
| Total lines added | +206,034 |
| Total lines removed | −83,207 |
| Net new lines | +122,827 |
...
- **Rust MCP server development** — detail in [private week 2026-04-12](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-04-12.md)
...
- **Document pipeline** — detail in [private week 2026-04-12](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-04-12.md)
