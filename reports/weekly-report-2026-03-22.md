...
> **Series restamp (2026-07-25):** Headline line stats now exclude `**/vendor/**` and `**/node_modules/**` (same rule as `gather.sh`). Figures below use remeasured excl-vendor totals from current default-branch history. Commits and effort estimates are unchanged. Vendor omitted this week: **+306,629/−0** (marcelocantos/jevons +306,629). Excl-vendor landed lines: **+717,622/−8,790** (net **+708,832**).
...
**246 commits** | **~+0.72M added / ~−9k removed** (excl. vendor) | **~120-185 person-days traditional equivalent** | **~30-50x multiplier**
...
- **HMS2 V1 achieved + V2 complete + hardening pass** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
...
- **bgfx migration and scene protocol** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
...
- **821 swallowed exceptions in HMS2** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
- **Schema mismatches from hallucinated column names** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
...
- **VRP reflection hack replaced with real OR-Tools** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
- **Dawn wire protocol removal** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
---
...
*Detailed narrative for this commercial work is in the private sibling: [progress-reports-private — week ending 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md).*
...
*Commercial detail for this section is in the private sibling: [week ending 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md).*
...
- **Healthcare domain modelling (CHSP/NDIS/SAH funding, OR-Tools…** — detail in [private week 2026-03-22](https://github.com/marcelocantos/progress-reports-private/blob/master/reports/weekly-report-2026-03-22.md)
